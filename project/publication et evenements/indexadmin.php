...
<!--Publications-->
  ...
  <thead>
    <tr>
      ...
      <th scope="col"></th>
      <th scope="col" colspan="2"><h5 style="color:#3b074e; text-align:center"><i class="bi bi-hand-index-thumb"></i> Actions</h5></th>
    </tr>
  </thead>
  ...
  <tbody>
    <tr>
      ...
      <td><a class="btn btn-warning btn-sm w-30" href="<?php echo $row1['Source']; ?>" role="button" data-ripple-color="#3b074e">Plus d'infos</a></td>
      <td><a class="btn btn-warning btn-sm w-30" href="supp.php?suppid='<?php echo $row1['Num'];?>'" role="button" data-ripple-color="#3b074e">Supprimer</a></td>
      <td><a class="btn btn-warning btn-sm w-30" href="mdf.php?mdfid='<?php echo $row1['Num'];?>'" role="button" data-ripple-color="#3b074e">Modofier</a></td>
    </tr>
...
<div class="d-grid gap-2">
  <a class="btn btn-warning" href="ajoutpub.php" role="button" data-ripple-color="#3b074e"> Ajouter</a>
</div>
...
<table class="table caption-top table-hover border-warning table-sm table-responsive">
  ...
  <tbody>
    <tr>
      ...
      <td><a class="btn btn-warning btn-sm w-30" href="#" role="button" data-ripple-color="#3b074e">Supprimer</a></td>
      <td><a class="btn btn-warning btn-sm w-30" href="#" role="button" data-ripple-color="#3b074e">Modofier</a></td>
    </tr>
...
<div class="d-grid gap-2">
  <a class="btn btn-warning" href="#" role="button" data-ripple-color="#3b074e"> Ajouter</a>
</div>
...
<table class="table caption-top table-hover border-warning table-sm table-responsive" id="Evènements_scientifiques">
  ...
  <tbody>
    <tr>
      ...
      <td><a class="btn btn-warning btn-sm w-30" href="suppevent.php?suppid='<?php echo $row8['Num']; ?>'" role="button" data-ripple-color="#3b074e">Supprimer</a></td>
      <td><a class="btn btn-warning btn-sm w-30" href="mdfevent.php?mdfid='<?php echo $row8['Num']; ?>'" role="button" data-ripple-color="#3b074e">Modofier</a></td>
    </tr>
...
<div class="d-grid gap-2">
  <a class="btn btn-warning" href="ajoutevent.php" role="button" data-ripple-color="#3b074e"> Ajouter</a>
</div>
