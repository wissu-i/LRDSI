...
`Num`='$num',`Titre`='$titre',`Type`='$type',`Lieu`='$lieu',`Date`='$date' 
 WHERE Num=$idnum";
...
<form method="post">
  ...
  <div class="form-outline mb-4">
    ...
    <label class="form-label" for="type" style="color:#3b074e">Type</label>
  </div>

  <!-- Lieu input -->
  <div class="form-outline mb-4">
    <input type="text" id="lieu" name="lieu" class="form-control" />
    <label class="form-label" for="lieu" style="color:#3b074e">Lieu</label>
  </div>
  ...
  <!-- Submit button -->
  <button type="submit" name="ajout" class="btn btn-warning btn-block">Modifier</button>
</form>
